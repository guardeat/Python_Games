...
class Circle():
    ...
    def move(self):
        ...
        self.speed.ivector*=0.95
        self.speed.jvector*=0.95
...
class eventHandler():
    ...
    def collider(circle1,circle2,distance):
        ...
        if distance<0.01: 
            return
        try:    
            i=10*(circle1.radius+circle2.radius-distance)*abs(circle1.center[0]-circle2.center[0])/(circle1.center[0]-circle2.center[0])
            j=10*(circle1.radius+circle2.radius-distance)*abs(circle1.center[1]-circle2.center[1])/(circle1.center[1]-circle2.center[1])
        except:
            i=0.01
            j=0.01
    ...
    def mover(circleList):
        for i2 in range(5):
            ...
            for i in circleList:
                i.move()  
            eventHandler.checkBordes(circleList,[700,200],200)    
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 4:
                    ...
                    a-=2 
        pygame.draw.circle(screen,(255,0,0),[700,200],200,1)        
