...
class Vector():
    ...
    def getLength(self):
        return math.hypot(self.ivector,self.jvector)/2
...
class Circle():
    ...
    def move(self):
        self.center[0] +=self.speed.ivector/100
        self.center[1] +=self.speed.jvector/100
...
class eventHandler():
    ...
    def collider(circle1,circle2,distance):
        ...
        if distance==0: 
            distance=0.1
        try:    
            i=2*abs(circle1.center[0]-circle2.center[0])/(circle1.center[0]-circle2.center[0])
            j=2*abs(circle1.center[1]-circle2.center[1])/(circle1.center[1]-circle2.center[1])
        except:
            i=0.01
            j=0.01
    ...
    def checkBordes(circleList,center,radius):
        ...
        for circle in circleList:
            ...
            if(distance>(radius-circle.radius)):
                ...
                i=b*circle.speed.getLength()/(c)*signa
                j=(b**2/a*circle.speed.getLength())/(c)*signb
