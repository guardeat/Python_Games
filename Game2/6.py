...
class Player(Entity):
    ...
    def setupImages(self):
        ...
        front1 = pygame.image.load("front1.png")
        front2 = pygame.image.load("front2.png")
        front3 = pygame.image.load("front3.png")
        front4 = pygame.image.load("front4.png")
    ...
    def getImage(self):
        ...
        if self.animationCount<8:
            ...
            if self.lastFrame==3:
                ...
                self.lastFrame+=1
            self.animationCount=0
        return self.front[self.lastFrame] 
...
def renderEntities(window,entityList,offset):
    for entity in entityList:
        ...
        window.blit(entity.getImage(),(entity.loc[0]-offset[0]+xSize/2-22,entity.loc[1]-offset[1]+ySize/2-20))
