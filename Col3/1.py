...
def Solve(block1,block2):
    ...
    cornerSolver(block1,block2,block2_corner,m)

    
        
def cornerSolver(block1,block2,block2_corner,m):
    ...
    if not (intertest[0]<(block1.x+block1.xsize) and intertest[0]>block1.x):
...
def main():
    ...
    blocks=[Block(500,300,100,100,0,0,True),testBlock]
