...
def drawPartickle(screen,aimList):
    a=0
    for i in aimList:
        red=random.randint(245,255)
        blue=random.randint(245,255)
        green=random.randint(245,255)
        pygame.draw.rect(screen,(red,green,blue),pygame.Rect(i.loc[0],i.loc[1], i.xsize, i.ysize))
        a+=4
